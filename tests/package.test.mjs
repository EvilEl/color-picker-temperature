...
test('packed files contain entry points and work for an isolated JS and TS consumer', () => {
  ...
  try {
    ...
    execFileSync(process.execPath, [join(root, 'node_modules/typescript/bin/tsc'), '--noEmit', '--strict', '--target', 'ES2016', '--module', 'NodeNext', '--moduleResolution', 'NodeNext', join(temporary, 'consumer.ts')], { cwd: temporary, stdio: 'pipe' });
